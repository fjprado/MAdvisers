...
batch_size = 1000
index_schema = "./index-schema-demo.json"
...
def load_search_index(data_json):
    start_client = CreateClient(endpoint, admin_key, index_name)
    ...
    batch_upload = batch_upload_json_data_to_index(data_json, search_client)
